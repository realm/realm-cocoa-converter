...
Whether you find a bug, typo or an API call that could be clarified, please [file an issue](https://github.com/realm/realm-cocoa-converter/issues) on our GitHub repository.
...
6. **Version of Realm Converter / Xcode / OSX**
7. **Version of involved dependency manager**
...
We love contributions to Realm Converter! If you'd like to contribute code, documentation, or any other improvements, please [file a Pull Request](https://github.com/realm/realm-cocoa-converter/pulls) on our GitHub repository. Make sure to accept our [CLA](#cla) and to follow our [style guide](https://github.com/realm/realm-cocoa/wiki/Objective-C-Style-Guide).
